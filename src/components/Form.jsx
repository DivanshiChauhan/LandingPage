const Form = () => {
  return (
    <section
      className="mt-20 px-4 sm:px-6 lg:px-20 text-black flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-6 sm:gap-10"
      style={{ fontFamily: '"Poppins", sans-serif' }}
    >
      <div className="flex flex-col lg:flex-row w-full gap-6 sm:gap-10 lg:gap-16 items-stretch">

        <div className="w-full lg:w-5/12 p-6 sm:p-8 bg-gradient-to-r from-gray-600 to-[#F5DEB3] text-white rounded-lg shadow-lg flex flex-col justify-between h-full flex-grow">
          <h2 className="text-2xl sm:text-3xl font-bold">Partner with Us for Comprehensive IT</h2>
          <p className="mt-2 text-base sm:text-lg">
            We’re happy to answer any questions you may have and help you determine which of our services best fit your needs.
          </p>
          <p className="mt-4 font-bold text-lg sm:text-xl">Call us at: 0612-2500-971</p>

          <h3 className="mt-4 text-lg sm:text-xl font-bold">Your benefits:</h3>
          ...
          <h3 className="mt-4 text-lg sm:text-xl font-bold">What happens next?</h3>
          <ol className="mt-2 space-y-1 text-sm sm:text-base">
        ...
        <div className="w-full lg:w-5/12 p-6 sm:p-8 bg-gradient-to-r from-gray-600 to-red-600 text-white rounded-lg shadow-lg flex flex-col justify-between h-full flex-grow">
          <h2 className="text-2xl sm:text-3xl font-bold">Schedule a Free Consultation</h2>
